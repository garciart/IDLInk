<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPage.master" AutoEventWireup="true" CodeFile="RoleEditor.aspx.cs" Inherits="AdminPages_RoleEditor" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
        ...
        <table style="border-style: none; vertical-align:top; border-color: inherit; border-width: 10px; width:100%;">
            <tr style="width:100%;">
                <td style="width:30%; vertical-align:top;">
                    ...
                    <ajaxToolkit:ModalPopupExtender ID="AddButton_ModalPopupExtender" runat="server" TargetControlID="hiddenButton" PopupControlID="AddButPopUp" PopupDragHandleControlID="AddButPopUp">
                    </ajaxToolkit:ModalPopupExtender>
                    <ajaxToolkit:ModalPopupExtender ID="RemoveButton_ModalPopupExtender" runat="server" TargetControlID="hiddenButton" PopupControlID="RemoveButPopUp" PopupDragHandleControlID="RemoveButPopUp">
                    </ajaxToolkit:ModalPopupExtender>
                </td>
                <td style="width:70%">
                    <table style="border-style: none; border-color: inherit; border-width: 10px; width:100%;">
                        <tr style="width:100%;">
                            <td style="width:45%">
                                ...
                                <asp:ListBox ID="AllUsersList" runat="server" Width="100%" Height="212px" SelectionMode="Multiple" />
                            </td>
                            ...
                            <td style="width:45%">
                                ...
                                <asp:ListBox ID="RoleUsersList" runat="server" Width="100%" Height="212px" SelectionMode="Multiple"/>
                            </td>
                        </tr>
                    </table>
                </td>  
    ...
    <div id="RemoveButPopUp" runat="server" style="width:181px; background-color:White; border: 2px solid black; text-align:center; display:none;">
