<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="edit_details.aspx.cs" Inherits="edit_details" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <ul>
        ...
        <li><asp:Label id="photo_upload_text" runat="server" Text="Photo: (Ensure face is centered; image will be cropped and resized)" />
            <p><asp:Image ID="current_photo" runat="server" /></p>
        ...
        <li>Current Signature:
            <p>
                <asp:Image ID="signatureOnFile" runat="server" AlternateText="Signature On File" />
            </p>
            <p>
                Enter a new signature below or leave blank to keep the current signature on file:
            </p>
